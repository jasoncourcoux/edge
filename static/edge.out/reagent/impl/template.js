...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7153__auto__,writer__7154__auto__,opt__7155__auto__){
return cljs.core._write(writer__7154__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12741 = o;
(G__12741[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6535__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6535__auto__){
var and__6535__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6535__auto____$1){
var and__6535__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__12749 = jsprops;
(G__12749["defaultValue"] = value);

(G__12749["onChange"] = ((function (G__12749,v,value,on_change){
return (function (p1__12747_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12747_SHARP_);
});})(G__12749,v,value,on_change))
);
...
var vec__12754 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12754,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12754,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12754,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12757 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12757 == null)){
} else {
var key_12758 = temp__4661__auto___12757;
(jsprops["key"] = key_12758);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12760 = (new reagent.impl.template.NativeWrapper());
(G__12760["name"] = c);
...
var G__12762 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12762) : reagent.impl.template.as_element.call(null,G__12762));
} else {
...
var len__7622__auto___12768 = arguments.length;
var i__7623__auto___12769 = (0);
while(true){
if((i__7623__auto___12769 < len__7622__auto___12768)){
args__7629__auto__.push((arguments[i__7623__auto___12769]));

var G__12770 = (i__7623__auto___12769 + (1));
i__7623__auto___12769 = G__12770;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7630__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12766){
var G__12767 = cljs.core.first(seq12766);
var seq12766__$1 = cljs.core.next(seq12766);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12767,seq12766__$1);
});
...
break;
default:
var G__12774 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12774;
continue;
...
var n__7462__auto___12777 = a.length;
var i_12778 = (0);
while(true){
if((i_12778 < n__7462__auto___12777)){
(a[i_12778] = reagent.impl.template.as_element((a[i_12778])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7462__auto___12780 = a.length;
var i_12781 = (0);
while(true){
if((i_12781 < n__7462__auto___12780)){
var val_12782 = (a[i_12781]);
if((cljs.core.vector_QMARK_(val_12782)) && ((reagent.impl.template.key_from_vec(val_12782) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12781] = reagent.impl.template.as_element(val_12782));

var G__12783 = (i_12781 + (1));
i_12781 = G__12783;
continue;
} else {
}
...
var ctx = {};
var vec__12785 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
...
var G__12787 = (cljs.core.count(argv) - first_child);
switch (G__12787) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12787){
