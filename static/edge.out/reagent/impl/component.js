...
if((i < len)){
var k = (ks[i]);
var G__12682 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12683 = (i + (1));
m = G__12682;
i = G__12683;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12687 = c;
var G__12687__$1 = (((G__12687 == null))?null:G__12687.prototype);
if((G__12687__$1 == null)){
return null;
} else {
return (G__12687__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12691 = c;
var G__12691__$1 = (((G__12691 == null))?null:G__12691.prototype);
if((G__12691__$1 == null)){
return null;
} else {
return (G__12691__$1["render"]);
}
})()));
});
...
var G__12695 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12695) : reagent.impl.component.as_element.call(null,G__12695));
};
var G__12697 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12698__i = 0, G__12698__a = new Array(arguments.length -  0);
while (G__12698__i < G__12698__a.length) {G__12698__a[G__12698__i] = arguments[G__12698__i + 0]; ++G__12698__i;}
...
var args = cljs.core.seq(arglist__12699);
...
var _STAR_current_component_STAR_12702 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12702;
}});
...
var G__12710 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12710) {
...
return ((function (G__12710){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12713 = reagent.impl.component.state_atom(c);
var G__12714 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12713,G__12714) : cljs.core.reset_BANG_.call(null,G__12713,G__12714));
});
;})(G__12710))
...
var or__6547__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__12716_12718 = (c["cljsRatom"]);
if((G__12716_12718 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12716_12718);
}
...
if(cljs.core.truth_((function (){var and__6535__auto__ = wrap;
...
var renders_12721 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12722], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6547__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6547__auto__)){
return or__6547__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6547__auto__ = render_fun;
if(cljs.core.truth_(or__6547__auto__)){
return or__6547__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6547__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6547__auto__)){
return or__6547__auto__;
} else {
...
var name__$1 = (function (){var G__12720 = name;
switch (G__12720) {
case "":
...
var elem = (function (){var G__12731 = (function (){var or__6547__auto__ = (function (){var G__12733 = c;
if((G__12733 == null)){
return null;
} else {
return (G__12733["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6547__auto__)){
return or__6547__auto__;
...
return (G__12731["_currentElement"]);
}
})();
var name = (function (){var G__12734 = elem;
var G__12734__$1 = (((G__12734 == null))?null:(G__12734["type"]));
if((G__12734__$1 == null)){
return null;
} else {
return (G__12734__$1["displayName"]);
}
})();
var path = (function (){var G__12735 = elem;
var G__12735__$1 = (((G__12735 == null))?null:(G__12735["_owner"]));
var G__12735__$2 = (((G__12735__$1 == null))?null:reagent$impl$component$component_path(G__12735__$1));
if((G__12735__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12735__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6547__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6547__auto__)){
return or__6547__auto__;
} else {
var G__12737 = c;
var G__12737__$1 = (((G__12737 == null))?null:G__12737.constructor);
if((G__12737__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12737__$1);
}
}
})();
